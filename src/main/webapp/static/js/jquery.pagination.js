...
(function($){
    ...
    $.extend($.PaginationRenderers.defaultRenderer.prototype, {
        ...
        createFirstLink:function (page_id,current_page,appendopts) {
        	var lnk;
        ...
        createLastLink:function (page_id,current_page,appendopts) {
            var lnk;
            if(page_id == current_page){
                lnk = $("<span class='current'>" + appendopts.text + "</span>");
            }
        ...
        getLinks:function(current_page, eventHandler) {
            ...
            if(this.opts.first_text && (current_page > 0 || this.opts.first_show_always)){
                fragment.append(this.createFirstLink(0,current_page,{text:this.opts.first_text}));
            }
            ...
            if(this.opts.last_text && (current_page > 0 || this.opts.last_show_always)){
            	// 第一个参数传递要去的页码，就是最大页码
                fragment.append(this.createLastLink(np-1,current_page,{text:this.opts.last_text}));
            }
            // 点击事件的重新绑定，这一行必须放在返回前的一行，否则会导致尾页功能失效。
